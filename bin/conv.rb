...
=end
  ...
  Prefixes = {
      ...
      [
        12,
        ['penty-atomic',        -40], ['penty-atomic ut',  -39], ['penty-atomic ti',  -38], ['penty-atomic la', -37],
        ['quadry-atomic fa',    -36], ['quadry-atomic mi', -35], ['quadry-atomic re', -34], ['quadry-atomic do',-33],
        ['quadry-atomic',       -32], ['quadry-atomic ut', -31], ['quadry-atomic ti', -30], ['quadry-atomic la',-29],
        ['try-atomic fa',       -28], ['try-atomic mi',    -27], ['try-atomic re',    -26], ['try-atomic do',   -25],
        ['try-atomic',          -24], ['try-atomic ut',    -23], ['try-atomic ti',    -22], ['try-atomic la',   -21],
        ['by-atomic fa',        -20], ['by-atomic mi',     -19], ['by-atomic re',     -18], ['by-atomic do',    -17],
        ['by-atomic',           -16], ['by-atomic ut',     -15], ['by-atomic ti',     -14], ['by-atomic la',    -13],
        ...
        ['by-cosmic mi',         13], ['by-cosmic re',      14], ['by-cosmic do',      15], ['by-cosmic',        16],
        ['by-cosmic ut',         17], ['by-cosmic ti',      18], ['by-cosmic la',      19], ['by-cosmic so',     20],
        ['try-cosmic mi',        21], ['try-cosmic re',     22], ['try-cosmic do',     23], ['try-cosmic',       24],
        ['try-cosmic ut',        25], ['try-cosmic ti',     26], ['try-cosmic la',     27], ['try-cosmic so',    28],
        ['quadry-cosmic mi',     29], ['quadry-cosmic re',  30], ['quadry-cosmic do',  31], ['quadry-cosmic',    32],
        ['quadry-cosmic ut',     33], ['quadry-cosmic ti',  34], ['quadry-cosmic la',  35], ['quadry-cosmic so', 36],
        ['penty-cosmic mi',      37], ['penty-cosmic re',   38], ['penty-cosmic do',   39], ['penty-cosmic',     40],
        ['penty-cosmic ut',      41]
      ] :
      [
        12,
        ['penty-atomic',        -40], ['penty-atomic Dirac', -39], ['penty-atomic Hecty',  -38], ['penty-atomic Kily',  -37],
        ['quadry-atomic sub',   -36], ['quadry-atomic milly',-35], ['quadry-atomic centy', -34], ['quadry-atomic dour', -33],
        ['quadry-atomic',       -32], ['quadry-atomic Dirac',-31], ['quadry-atomic Hecty', -30], ['quadry-atomic Kily', -29],
        ['try-atomic sub',      -28], ['try-atomic milly',   -27], ['try-atomic centy',    -26], ['try-atomic dour',    -25],
        ['try-atomic',          -24], ['try-atomic Dirac',   -23], ['try-atomic Hecty',    -22], ['try-atomic Kily',    -21],
        ['by-atomic sub',       -20], ['by-atomic milly',    -19], ['by-atomic centy',     -18], ['by-atomic dour',     -17],
        ['by-atomic',           -16], ['by-atomic Dirac',    -15], ['by-atomic Hecty',     -14], ['by-atomic Kily',     -13],
        ...
        ['by-cosmic milly',      13], ['by-cosmic centy',     14], ['by-cosmic dour',       15], ['by-cosmic',           16],
        ['by-cosmic Dirac',      17], ['by-cosmic Hecty',     18], ['by-cosmic Kily',       19], ['by-cosmic Super',     20],
        ['try-cosmic milly',     21], ['try-cosmic centy',    22], ['try-cosmic dour',      23], ['try-cosmic',          24],
        ['try-cosmic Dirac',     25], ['try-cosmic Hecty',    26], ['try-cosmic Kily',      27], ['try-cosmic Super',    28],
        ['quadry-cosmic milly',  29], ['quadry-cosmic centy', 30], ['quadry-cosmic dour',   31], ['quadry-cosmic',       32],
        ['quadry-cosmic Dirac',  33], ['quadry-cosmic Hecty', 34], ['quadry-cosmic Kily',   35], ['quadry-cosmic Super', 36],
        ['penty-cosmic milly',   37], ['penty-cosmic centy',  38], ['penty-cosmic dour',    39], ['penty-cosmic',        40],
        ['penty-cosmic Dirac',   41]
      ],
